<div align="center"><h2>FRONTEND JOBS</h2></div><table><tr>
                <td width="100" height="100" rowspan="2">
                    <img src="https://wwr-pro.s3.amazonaws.com/logos/0083/2202/logo.gif" width="38px" height="auto">
                </td>
                <td width="300">
                    <h5>Overleaf</h5>
                    <h3> Frontend Engineer (Remote UK/EU/USA/Canada)</h3>
                </td>
                <td width="300">
            ...
            <tr>
                ...
                <img src="https://we-work-remotely.imgix.net/logos/0083/2202/logo.gif?ixlib=rails-4.0.0&w=50&h=50&dpr=2&fit=fill&auto=compress" />
...
<p>We have over 11 million registered users from around the world, over 400,000 people use our platform each day and we host over 100 million user-created projects. Our company is growing and we are looking for Frontend Engineers to help improve our platform.</p>
...
<p>On the front end, we mainly use React. On the backend, we run a microservices architecture, mainly in Node.js using MongoDB, PostgreSQL and Redis, running on Google Kubernetes Engine.</p>
<p><strong>Your New Role</strong></p>
<p>We are looking to hire a frontend engineer to help improve our platform. This is a complex web app that allows users to edit their scientific documents in collaboration with others, in real-time.</p>
<p>We are working on projects that include improved collaboration features for teams, and improvements to our rich text editor to help non-LaTeX users get started with our platform.</p>
<p>There will be opportunities to work on the backend, so both frontend and full-stack engineers are welcome to apply. (We also have openings for backend engineers.)</p>
...
<p><strong>To apply:</strong> <a href="https://weworkremotely.com/remote-jobs/overleaf-frontend-engineer-remote-uk-eu-usa-canada">https://weworkremotely.com/remote-jobs/overleaf-frontend-engineer-remote-uk-eu-usa-canada</a></p>
