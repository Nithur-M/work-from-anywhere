<div align="center"><h2>PRODUCT MANAGER JOBS</h2></div><table><tr>
                <td width="100" height="100" rowspan="2">
                    <img src="https://remotive.com/job/1900586/logo" width="38px" height="auto">
                </td>
                <td width="300">
                    <h5>Xealth</h5>
                    <h3>Senior Product Manager, Clinical Data & AI</h3>
                </td>
                <td width="300">
                ...
                <a href="https://remotive.com/remote-jobs/product/senior-product-manager-clinical-data-ai-1900586" align="right" target="_blank">Apply</a>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                <details><summary>Description</summary>
                <p><strong>Senior Product Manager, Clinical Data &amp; AI</strong></p>
<p>In today’s world of Value Based Care, Patient Engagement has become a requirement for success.  Xealth’s owes its success in Patient Engagement to its clinical data platform that is fed by EHR data and patient generated data (device data, activity data, etc.)  That real-time data enables Xealth to send the right message to the right patient at the right time.</p>
<p>As the <em>Senior Product Manager for Clinical Data and AI</em>, you’ll own the vision and roadmap for Xealth’s continued data acquisition efforts as well as the AI strategy against that data towards better patient outcomes. You’ll work with a dynamic range of internal and external executive stakeholders. This is a mission-critical role that's instrumental to our overall goal of improving healthcare for everyone. </p>
<p><strong>Core job competencies:</strong></p>
<ul style="">
<li style="">Own the vision and roadmap for Xealth’s clinical data acquisition initiatives</li>
<li style="">Own the vision and roadmap for Xealth’s AI offering</li>
<li style="">Secure commitments from Payor and Health System customers to buy or utilize your products</li>
<li style="">Distill market trends, customer feedback, and Xealth’s product vision into an executable roadmap</li>
<li style="">Manage delivery of products, features, and enhancements in collaboration with engineering team members</li>
<li style="">Build relationships with customers and vendors to further Xealth’s mission</li>
<li style="">Educate cross functional stakeholders such as sales/marketing, implementation, and support about product updates to ensure seamless deployments and rollouts</li>
<li style="">Make a real, positive difference in other people's lives through your work</li>
</ul>
<p><strong>Skills &amp; Qualifications:</strong></p>
<ul style="">
<li style="">First hand experience integrating clinical data into EMR/EHR workflows</li>
<li style="">Product level understanding of HL7 and FHIR</li>
<li style="">Product level understanding of generative AI vs. machine learning</li>
<li style="">5-10 years of experience working as a Product Manager for a web-based, SaaS, or cloud offering</li>
<li style="">Experience working with Clinical Stakeholders at Health Systems to identify, design, deliver, and scale technology solutions successfully</li>
<li style="">Familiarity with the Digital Therapeutic landscape, and how these solutions deliver value to Health Systems</li>
<li style="">Working experience managing products that closely integrate with existing 3rd party systems </li>
<li style="">Computer Science degree or equivalent work experience with ability to meaningfully engage in design discussions with software developers</li>
<li style="">Extensive experience in Lean and/or Agile software development processes</li>
<li style="">Prior success as a cross-team influencer, with a proven track record of establishing relationships and managing expectations both internally within an organization and externally with customers</li>
</ul>
<p><strong><em>About Xealth:</em></strong></p>
<p><span style='"font-weight:'>Xealth is a digital-health clearinghouse in the cloud, enabling clinicians to easily prescribe digital health tools for their patients, monitor their progress, drive usage, and ultimately attain improved health (with significantly lower long-term health costs).</span></p>
<p><span style='"font-weight:'>Xealth spun out of Providence St. Joseph Health (PSJH) in 2017. Investors include Atrium Health, Cerner, Cleveland Clinic, MemorialCare Innovation Fund, McKesson Ventures, Novartis, Philips, ResMed, Providence Ventures, UPMC and the Froedtert and Medical College of Wisconsin Health Network.</span></p>
<p><span style='"font-weight:'>Due to patient success and subsequent clinician demand, Xealth is experiencing rapid growth in the clinical Healthcare IT space, most recently receiving an investment from Cerner in 2020, as part of our developing collaboration with them.</span></p>
<p><span style='"font-weight:'>Xealth has been named to the CB Insights Digital Health 150, awarded the “Best Connected Health Platform” by the MedTech Breakthrough Awards, and was named to Fast Company’s Annual List of the World’s Most Innovative Companies in 2020.</span></p>
<p><strong>Compensation &amp; Benefits</strong></p>
<p><span style='"font-weight:'>Xealth offers a multi-tiered approach when constructing a highly competitive compensation package.</span></p>
<p><em><span style='"font-weight:'>Xealth is committed to providing reasonable accommodations for qualified individuals with disabilities and disabled veterans in our job application procedures.</span></em></p><img src="https://remotive.com/job/track/1900586/blank.gif?source=public_api" alt=""/>
                </details>
                </td>
            </tr>,<tr>
                <td width="100" height="100" rowspan="2">
