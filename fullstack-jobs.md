<div align="center"><h2>FULLSTACK JOBS</h2></div><table><tr>
                <td width="100" height="100" rowspan="2">
                    <img src="https://wwr-pro.s3.amazonaws.com/logos/0086/7336/logo.gif" width="38px" height="auto">
                </td>
                <td width="300">
                    <h5>Frost</h5>
            ...
            <tr>
                ...
                <img src="https://we-work-remotely.imgix.net/logos/0086/7336/logo.gif?ixlib=rails-4.0.0&w=50&h=50&dpr=2&fit=fill&auto=compress" />
...
<li>Experience with front-end development using React.js</li>
<li>Experience with back-end development using Node.js</li>
<li>Knowledge of relational databases and their management</li>
<li>Business-level English language proficiency (fluency)</li>
</ul><div>
<strong><br>Experience &amp; Education<br></strong><br>
</div><ul>
<li>Minimum of 5 years of professional experience as a software engineer, preferably in a senior role</li>
<li>Bachelor’s degree in Computer Science, Engineering, or a related field (preferred but not required)</li>
</ul><div>
<strong><br>Key Responsibilities<br></strong><br>
</div><ul>
<li>Develop and maintain our SaaS platform, including both front-end and back-end components</li>
<li>Collaborate with the team to understand business requirements and translate them into technical tasks</li>
<li>Ensure timely completion of tasks and deliver high-quality results</li>
</ul><div>
<strong><br>Collaboration<br></strong><br>
</div><ul><li>As an early-stage startup, you will primarily work closely with the CEO and CTO to drive product development and innovation</li></ul><div>
<strong><br>Employment Type<br></strong><br>
</div><ul><li>Part-time position with the potential for transitioning to a full-time role, based on mutual agreement and satisfactory performance</li></ul><div>
<strong><br>Preferred Qualifications<br></strong><br>
</div><ul>
